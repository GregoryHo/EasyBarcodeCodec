package com.ns.greg.library.barcodecodec.utils;
...
public final class CameraConfigurationUtils {
  ...
  public static Point findBestPreviewSizeValue(Camera.Parameters parameters,
    ...
    // Find a suitable size, with most equal resolution
    Point mostEqualSize = new Point(0, 0);
    ...
    for (Camera.Size size : rawSupportedSizes) {
      ...
      int delta = Math.abs(realWidth - screenResolution.y) + Math.abs(realHeight - screenResolution.x);
      if (delta == 0) {
        mostEqualSize.set(realWidth, realHeight);
        return mostEqualSize;
