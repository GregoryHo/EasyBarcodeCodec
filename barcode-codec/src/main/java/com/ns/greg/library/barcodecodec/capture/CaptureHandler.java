...
import com.ns.greg.library.barcodecodec.module.decode.DecodeThread;
...
public final class CaptureHandler extends Handler {
  ...
  CaptureHandler(Capture capture, BarCodeDecoder barCodeDecoder,
      CameraManager cameraManager) {
    this.capture = capture;
    decodeThread = new DecodeThread(this, barCodeDecoder, cameraManager);
    decodeThread.start();
    state = State.SUCCESS;
