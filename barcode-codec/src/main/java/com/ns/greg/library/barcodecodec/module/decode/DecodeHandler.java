...
import static com.ns.greg.library.barcodecodec.capture.CaptureHandler.DECODE;
import static com.ns.greg.library.barcodecodec.capture.CaptureHandler.DECODE_FAILED;
import static com.ns.greg.library.barcodecodec.capture.CaptureHandler.DECODE_SUCCEEDED;
import static com.ns.greg.library.barcodecodec.capture.CaptureHandler.QUIT;
...
final class DecodeHandler extends Handler {
  ...
  private void decode(byte[] data, int width, int height) {
    ...
    // rotated width and height, the camera resolution is height x width,
